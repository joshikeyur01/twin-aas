# Vendored verbatim from twin-services (services/state-svc/src/state_svc/kinematics.py).
# Do not diverge: fix bugs there first, then re-vendor. Fairness rule: this
# file is the only FK implementation in twin-aas, and it runs only in the feeder.
